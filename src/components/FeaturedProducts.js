  ...
  return (
    <div className="w-5/6  mx-auto mb-40">
      ...
      <div className="text-center">
        <h1 className="text-[#737373] text-[1.25rem] font-semibold">
          Featured Products
        </h1>
        <h1 className="text-[#252B42] font-bold text-[1.5rem] tracking-[0.0625rem] my-4">
          THE BEST SERVICES
        </h1>
        <p className="text-[#737373] text-[0.875rem] font-semibold">
      ...
      <div className="flex flex-wrap justify-around mobile:mt-10 mt-40">
        <div className="text-center">
          ...
          <h1 className="my-8 text-[#252B42] text-[1.5rem] font-bold">
            Easy Wins
          </h1>
          <p className="text-[#737373] text-[0.875rem] font-semibold">
