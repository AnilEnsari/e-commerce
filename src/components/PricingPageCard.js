  ...
  return (
    <div className="w-[90rem] py-[7rem] mx-auto">
      <div className="w-[40rem] mx-auto">
        <h1 className="text-[#252B42] text-[2.5rem] font-bold text-center">
          Pricing
        </h1>
        <p className="text-[#737373] font-bold text-center mt-[0.62rem]">
      ...
      <div className="flex justify-center my-[3rem] relative gap-4">
        ...
        <button className="px-[1.25rem] py-[0.62rem] bg-[#B2E3FF] text-[#23A6F0] rounded-[2.3125rem]">
          Save 25%
        </button>
      </div>
      ...
      <div className="flex">
        <div className="w-[33.3%] py-[3.12rem] px-[2.5rem] border border-[#23A6F0] rounded-[0.625rem]">
          <h1 className="text-[#252B42] font-bold text-center text-[1.5rem]">
            FREE
          </h1>
          <p className="text-[#737373] font-bold text-center py-[2.18rem]">
            Organize across all apps by hand
          </p>
          <div className="flex justify-center gap-4">
            <p className="text-[#23A6F0] text-[2.5rem] font-bold text-center">
              0
            </p>
            <div className="">
          ...
          <div className="py-[2.19rem]">
            <div className="flex gap-8 justify-center items-center">
              <div className="overflow-hidden bg-[#2dc071] flex flex-col justify-center w-12 h-12 items-center rounded-[200px]">
                <img
                  alt="product"
                  src="https://file.rendit.io/n/CE38GqHM97AzPPTCcQhA.svg"
                  className="w-6"
                />
              </div>
        ...
        <div className="w-[33.3%] py-[3.12rem] px-[2.5rem] bg-[#252B42] border border-[#23A6F0] rounded-[0.625rem]">
          <h1 className="text-[#FFFFFF] font-bold text-center text-[1.5rem]">
            STANDART
          </h1>
          <p className="text-[#FFFFFF] font-bold text-center py-[2.18rem]">
            Organize across all apps by hand
          </p>
          <div className="flex justify-center gap-4">
            <p className="text-[#23A6F0] text-[2.5rem] font-bold text-center">
